...
export class PetFormComponent implements OnInit {
 ...
 // used in ngmodel to clear photoUrl input field after add
  ...
  tagCheck(tag: { id: number; name: string; }) {
    let found = null;
  ...
  buildTagResponse(tagObj: { [x: string]: any; }) {
    const finalTagObj: { id: string; }[] = [];
